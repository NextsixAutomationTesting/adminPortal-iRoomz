...
WebUI.setText(findTestObject('Unit/input_Unit Name_propertyUnitName'), 
    unitName)
...
if (manage == 2) {
    ...
    WebUI.setText(findTestObject('Unit/input_Management Fee_managementFee'), 
        '10')
...
WebUI.setText(findTestObject('Unit/input_Room Name_roomData.0.name'), 
    room1)
...
WebUI.setText(findTestObject('Unit/input_Room Type_roomData.0.roomType'), 
    'Master Bedroom')

WebUI.setText(findTestObject('Unit/input_RM_roomData.0.rentalDeposit'), 
    rental)

WebUI.setText(findTestObject('Unit/input_RM_roomData.0.utilityDeposit'), 
    '0')

WebUI.setText(findTestObject('Unit/input_RM_roomData.0.ratePerUnit'), 
    '0.65')
...
WebUI.setText(findTestObject('Unit/input_Room Name_roomData.1.name'), 
    room2)

rental2 = RandomStringUtils.randomNumeric(2) + '0'

WebUI.setText(findTestObject('Unit/input_RM_roomData.1.rental'), rental2)

WebUI.setText(findTestObject('Unit/input_Room Type_roomData.1.roomType'), 
    'Small Bedroom')

WebUI.setText(findTestObject('Unit/input_RM_roomData.1.rentalDeposit'), 
    rental2)

WebUI.setText(findTestObject('Unit/input_RM_roomData.1.utilityDeposit'), 
    '0')

WebUI.setText(findTestObject('Unit/input_RM_roomData.1.ratePerUnit'), 
    '0.65')
...
WebUI.verifyElementText(findTestObject('Unit/p_CZH0191_Room 1 - 2200.00'), 
    created)
